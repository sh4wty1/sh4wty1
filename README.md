...
[![My Skills](https://skillicons.dev/icons?i=java,ts,python,js,spring,postgresql,docker,react,tailwind,vite,git,vscode,visualstudio,windows,linux)](https://skillicons.dev)
<br/>
<br/>
